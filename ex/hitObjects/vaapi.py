...
#  (op.w, op.h))
cmd = ['ffmpeg', '-vaapi_device', '/dev/dri/renderD128'
  '-f', 'rawvideo', '-pix_fmt', 'bgr24', '-r', str(fps), '-s', '{}x{}'.format(op.w, op.h), 
  '-i', '-', 
  '-y', '-vf', "\'format=nv12,hwupload\'", '-c:v', 'h264_vaapi', '-crf', '18', 'video.avi']
